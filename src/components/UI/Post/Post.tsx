...
const Post = () => {
  return (
    <div className="Post">
      ...
      alt="Post Item"
      loading="lazy"
      className="post__image" // Глобальный класс для стилизации
    />
        <img src="./img/users/aleksandr-maykov.jpeg" alt="User" />
        <div className="userDescription">
          <a href="#" className="mainText">
            Александр Майков
          </a>
          <p className="secondaryText">Сегодня 9:37</p>
        </div>
      </div>
      <p className="postText">Момент умиротворения и спокойствия</p>
      <div className="mediaContainer">
        <img
          ...
          alt="Post Item"
        />
        {/* Include other media images similarly */}
      </div>
      <div className="postControls">
        <div className="iconWrapper like">
          <span className="count likesCount">-500</span>
          <svg
